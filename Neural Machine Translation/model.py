...
class seq2seqModel(nn.Module):
    ...
    def forward(self,input,max_size,is_prod):
        ...
        while True:
            ...
            if self.do_att:
                source_context,attention = self.att_mech(target_h,source_hs) # (1,batch,feat)
            ...
            with tqdm(total=len(train_loader),unit_scale=True,postfix={'loss':0.0,'test loss':0.0},
                ...
                for loader_idx, loader in enumerate([train_loader, test_loader]):
                    ...
                    for i, (batch_source,batch_target) in enumerate(loader):
                        ...
                        unnormalized_logits,attentions_weights = self.forward(batch_source,max_size,is_prod)
    ...
    def predict(self,source_nl):
        ...
        logits,attentions= self.forward(source_ints,source_ints.size(0),True) # (seq) -> (<=max_size,vocab)
